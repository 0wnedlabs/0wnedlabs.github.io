...
TE.wait(1000, false).then(TE.enterInput.bind(TE, 'Welcome To 0wnedlab.')).then(TE.enterCommand.bind(TE)).then(TE.enterResponse.bind(TE, 'npm installing packages...')).then(TE.wait.bind(TE, 2000)).then(TE.enterResponse.bind(TE, '- style v9.9.9 installed.')).then(TE.wait.bind(TE, 600)).then(TE.enterResponse.bind(TE, '- markup v0.1.0 installed. ')).then(TE.wait.bind(TE, 600)).then(TE.enterResponse.bind(TE, '- scripts v9.9.9 installed. ')).then(TE.wait.bind(TE, 300)).then(TE.enterResponse.bind(TE, '- 10 billion dependencies installed. ')).then(TE.wait.bind(TE, 700)).then(TE.enterResponse.bind(TE, 'Make website responsive? (y/y)')).then(TE.wait.bind(TE, 2000, false)).then(TE.enterInput.bind(TE, 'y')).then(TE.enterCommand.bind(TE)).then(TE.wait.bind(TE, 400)).then(TE.enterResponse.bind(TE, 'Make website accessible? (y/y)')).then(TE.wait.bind(TE, 1800, false)).then(TE.enterInput.bind(TE, 'y')).then(TE.enterCommand.bind(TE)).then(TE.wait.bind(TE, 400)).then(TE.enterResponse.bind(TE, 'finalizing...')).then(TE.wait.bind(TE, 2000)).then(TE.enterResponse.bind(TE, 'Website complete! Wasn\'t that easy?')).then(TE.reset.bind(TE));